...
class IsolatedRunner:
    ...
    def __init__(self, name: str, config: Optional[IsolationConfig] = None):
        ...
        resource_limits = ResourceLimits(
            ...
            memory_limit=CgroupManager.parse_memory_string(self.config.memory_limit) 
                        if self.config.memory_limit else None,
    ...
    def isolation_available(self) -> bool:
        ...
        return (self._namespace_mgr.is_available or 
                self._cgroup_mgr.is_available or 
                self._fs_mgr.is_available)
    ...
    def get_isolation_summary(self) -> Dict[str, str]:
        ...
        return {
            ...
            "cgroups": "available" if self._cgroup_mgr.is_available else "not available",
    ...
    def run(self, 
            ...
            stderr: Optional[int] = None) -> subprocess.Popen:
        """
    ...
    def _run_basic(self,
                   ...
                   stdout: Optional[int],
                   stderr: Optional[int],
                   cgroup_created: bool) -> subprocess.Popen:
        """
    ...
    def _generate_isolation_wrapper(self, 
                                   command: List[str], 
                                   env: Dict[str, str],
