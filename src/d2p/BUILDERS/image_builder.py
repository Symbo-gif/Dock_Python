...
class LayerCache:
    ...
    def get_cache_key(self, instruction: str, parent_digest: str, 
...
class ImageBuilder:
    ...
    def build_with_context(self, context: BuildContext) -> ContainerImage:
        ...
        for inst in instructions:
            ...
            if cmd == "FROM":
                ...
                current_image = ContainerImage(name=context.image_name, base_image=base_ref)
        ...
        return current_image or ContainerImage(name=context.image_name, base_image="scratch")
    ...
    def _handle_copy(self, image: ContainerImage, args: List[str], 
                     context: BuildContext, stages: Dict[str, ContainerImage]) -> None:
        """Handle COPY instruction."""
    ...
    def _handle_add(self, image: ContainerImage, args: List[str], 
    ...
    def execute_copies(self, image: ContainerImage, dest_dir: str, 
            ...
            for source in sources:
                ...
                if source_path.is_dir():
                    ...
                    if dest.endswith("/") or (dest_path.exists() and dest_path.is_dir()):
                        ...
                        shutil.copy2(str(source_path), str(dest_path / source_path.name))
                    else:
                        shutil.copy2(str(source_path), str(dest_path))
    
    def execute_run_instructions(self, image: ContainerImage, 
                                 rootfs: str,
