...
class RegistryClient:
    ...
    def _make_request(self, 
                      url: str, 
                      ref: ImageReference,
                      accept: Optional[str] = None) -> Tuple[bytes, Dict[str, str]]:
    ...
    def _select_platform_manifest(self, 
                                  ref: ImageReference, 
                                  manifest_list: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for manifest in manifest_list.get("manifests", []):
            ...
            if platform_info.get("os") == os_name and platform_info.get("architecture") == arch:
    ...
    def get_config(self, ref: ImageReference, manifest: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def pull_layer(self, 
        ...
        if actual_digest != digest:
            raise ValueError(f"Layer digest mismatch: expected {digest}, got {actual_digest}")
    ...
    def pull_image(self, image_name: str, dest_dir: Optional[str] = None) -> str:
        ...
        if dest_dir:
            ...
            rootfs = self.cache_dir / "images" / ref.repository.replace("/", "_") / image_id / "rootfs"
